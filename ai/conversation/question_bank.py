...
#
# These identifiers follow the field names specified in the project brief.
# If ontology.py uses different identifiers, replace these constants with
# the exact ontology identifiers.
# ---------------------------------------------------------------------------
